...
class PersonalInfoUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'id_card' => ['required', 'string', 'max:15', 'unique:personal_infos,id_card,' . $this->route('personal_info')->id,],
            ...
            'email' => ['required', 'email', 'max:60', 'unique:personal_infos,email,' . $this->route('personal_info')->id],
